    ...
    >
      ...
      <div className="relative z-20 overflow-hidden px-6 md:px-10">
        <FadeIn
          ...
          delay={0.15}
          y={40}
          className="hero-heading mt-6 w-full whitespace-nowrap text-[9.5vw] font-black uppercase leading-none tracking-tight sm:mt-4 sm:text-[10vw] md:-mt-5 lg:text-[10.5vw]"
        >
          Hi, i&apos;m aleppo dev
        </FadeIn>
      </div>
