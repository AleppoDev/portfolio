      ...
      <div className="mx-auto max-w-5xl">
        {services.map((service, i) => (
          <FadeIn
            ...
            delay={i * 0.1}
            y={30}
            className="flex items-start gap-5 border-t py-8 last:border-b sm:gap-8 sm:py-10 md:gap-12 md:py-12"
          ...
          >
            ...
            <div className="flex flex-col gap-2 pt-1 sm:gap-3 md:gap-4">
              <h3
